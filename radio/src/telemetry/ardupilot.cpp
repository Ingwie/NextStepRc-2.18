...
void menuTelemetryArduPilot2(uint8_t event)
{
    ...
    lcdDrawTextAtt (2*FW, 5*FH, VALSTR(1), APSIZE);
}
...
void title(char x)
{
    lcdDrawTextAtt (0, 0, PSTR(" ARDU PILOT Mega ?/8 "), INVERS);
    lcdDrawCharAtt(17*FW, 0*FH, x, INVERS);
}
